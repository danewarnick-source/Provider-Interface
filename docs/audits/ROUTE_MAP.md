...
Companion to [`LAUNCH_READINESS_AUDIT.md`](LAUNCH_READINESS_AUDIT.md). This lists buttons, nav items, links, cards, and tabs with their destination, so a non-technical reader can eyeball mismatches.
