...
export const TOUR_ANCHORS: TourAnchor[] = [
  ...
  { id: "nav.compliance", label: "Compliance", route: "/dashboard/compliance", description: "Staff file, Client file, and Agency file — org-wide file status and company policies.", surface: "admin" },
