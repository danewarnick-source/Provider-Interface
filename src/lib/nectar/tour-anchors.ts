...
export const TOUR_ANCHORS: TourAnchor[] = [
  ...
  { id: "nav.compliance", label: "Evidence", route: "/dashboard/evidence", description: "Staff, Client, and Company evidence packs — upload or attest. Suggestions only.", surface: "admin" },
  { id: "nav.evidence", label: "Evidence", route: "/dashboard/evidence", description: "People × requirements tracker. Packs are suggestions, not a scoreboard.", surface: "admin" },
  { id: "nav.personnel-file", label: "Staff file", route: "/dashboard/compliance", description: "Org-wide staff file status — missing, due soon, and on file.", surface: "admin" },
  { id: "nav.client-file", label: "Client file", route: "/dashboard/compliance", description: "Org-wide client file status — missing, due soon, and on file.", surface: "admin" },
  { id: "nav.agency-documents", label: "Agency file", route: "/dashboard/compliance", description: "Org-wide standing flags, encoded DSPD policies, and the company-policies binder.", surface: "admin" },
  ...
  { id: "nav.my-obligations", label: "Staff file", route: "/dashboard/my-obligations", description: "Trainings, policies, and other items you still owe.", surface: "staff" },
  ...
  { id: "nav.courses", label: "Staff file", route: "/dashboard/my-obligations", description: "Assigned trainings and forms — staff only complete what is already on the staff file.", surface: "staff" },
