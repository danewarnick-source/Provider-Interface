...
export type AuditItem = {
  ...
  /** Stable catalog keys that satisfy this row. */
...
export const DSPD_AUDIT_ITEMS: AuditItem[] = [
  ...
  },
  {
    ...
    obligation_keys: ["pps_foster_license"],
    fulfillment: "external",
  ...
  },
  {
    ...
    obligation_keys: ["epr_community_20pct"],
    fulfillment: "in_hive",
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["no_gifts_process"],
    fulfillment: "standing",
  ...
  },
  {
    ...
    citation: "CST 9 & 10",
    applies_to_codes: [],
    obligation_keys: ["conflict_of_interest_process"],
    fulfillment: "standing",
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["person_discharge_process"],
    fulfillment: "standing",
  ...
  },
  {
    ...
    citation: "CST 29–36",
    applies_to_codes: [],
    obligation_keys: ["liability_insurance"],
    fulfillment: "standing",
  ...
  // ── PART II ─────────────────────────────────────────────────────────────
  {
    ...
    obligation_keys: ["medical_dental_exams"],
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["support_strategies"],
    fulfillment: "in_hive",
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["grievance_acknowledgment"],
    hive_href: "/dashboard/hub/clients",
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["rights_restriction_record"],
    hive_href: "/dashboard/hub/documentation?tab=hrc",
  ...
  },
  {
    ...
    obligation_keys: ["belongings_inventory"],
    hive_href: "/dashboard/hub/clients",
  ...
  },
  {
    ...
    applies_to_codes: ["HHS"],
    obligation_keys: ["hhs_room_board_agreement"],
    hive_href: "/dashboard/hub/clients",
  ...
  },
  {
    ...
    applies_to_codes: ["RHS"],
    obligation_keys: ["rhs_lease_agreement"],
    fulfillment: "in_hive",
  ...
  },
  {
    ...
    applies_to_codes: ["PPS"],
    obligation_keys: ["pps_room_board_agreement"],
    fulfillment: "in_hive",
  ...
  },
  {
    ...
    condition: "if_pba",
    obligation_keys: ["pba_financial_review"],
    fulfillment: "hybrid",
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["emergency_loan_record"],
    hive_href: "/dashboard/client-loans",
  ...
  // ── PART III ────────────────────────────────────────────────────────────
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["timesheets_attendance"],
  ...
  },
  {
    ...
    obligation_keys: ["evv_visit_verification"],
    hive_href: "/dashboard/compliance-desk",
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["billing_service_match"],
  ...
  },
  {
    ...
    applies_to_codes: ["HHS"],
    obligation_keys: ["hhs_billable_day"],
  ...
  },
  {
    ...
    obligation_keys: ["dhhs_code_of_conduct_signed"],
    fulfillment: "in_hive",
  ...
  },
  {
    ...
    obligation_keys: ["educational_credentials"],
    fulfillment: "standing",
  ...
  },
  {
    ...
    citation: "CST 46",
    applies_to_codes: [],
    obligation_keys: ["em_bcp_training_annual"],
    fulfillment: "in_hive",
  ...
  },
  {
    ...
    applies_to_codes: [],
    obligation_keys: ["behavior_intervention_cert"],
    fulfillment: "in_hive",
...
/** Keys are stable; client-prefixed titles resolve to the same catalog key. */
export function obligationKeyMatches(actualKey: string, templateKey: string): boolean {
  if (actualKey === templateKey) return true;
  const actual = sowCatalogEntryByKey(actualKey) ?? sowCatalogEntry(actualKey);
  const template = sowCatalogEntryByKey(templateKey);
  if (!actual || !template) return false;
  return actual.key === template.key;
}
