...
export const EVIDENCE_HELP_LINKS = {
  ...
  olApps: {
    label: "Office of Licensing applications and renewals",
    href: "https://dlbc.utah.gov/home/office-of-licensing/human-services/applications-and-renewals/",
  },
  olRules: {
    label: "Office of Licensing rules and descriptions",
    href: "https://dlbc.utah.gov/home/office-of-licensing/human-services/rules-and-descriptions/",
  },
  training: {
    label: "DSPD provider trainings",
    href: "https://dspd.utah.gov/providers/trainings/",
  },
...
export const EVIDENCE_REQUIREMENTS: readonly EvidenceRequirementDef[] = [
  ...
  req({
    key: "annual_12hr_training",
    title: "Annual 12-hour training",
    evidenceType: "upload",
    attestationText: null,
    cadence: "annual",
    sowCite: "SOW §1.8(7)",
    cadenceDisplay: "Annual (hire anniversary) · SOW §1.8(7)",
    why: "Each staff member completes at least 12 hours of training during their hire-anniversary year, not the calendar year. Upload a log, certificates, or other proof that the hours were completed.",
    links: [EVIDENCE_HELP_LINKS.training],
    subject: "staff",
    dualLink: null,
  }),
  ...
  req({
    ...
    why: "The agency must maintain at least one ACRE-certified staff member (SOW §30.6.b). If this person holds that credential, keep their ACRE certificate here. A matching company-file row is available as agency standing.",
    subject: "staff",
    dualLink: null,
  }),
  req({
  ...
  req({
    key: "company_ol_day_treatment_license",
    title: "OL Day Treatment license (4+)",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §7.5 / §8.5 / §9.6",
    cadenceDisplay: "On expiry · SOW §7.5 / §8.5 / §9.6",
    why: "If you operate a day site for four or more people at a location (DSI, DSG, DSP, or EPR), keep the Office of Licensing Day Treatment license current. This is optional agency standing—skip it if you only use the three-or-fewer Day Support path.",
    links: [EVIDENCE_HELP_LINKS.olApps, EVIDENCE_HELP_LINKS.olRules],
    subject: "company",
    dualLink: null,
  }),
  req({
    key: "company_ol_day_support_cert",
    title: "Day Support / Community-Based Day Support certification (≤3)",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §7.5 / §8.5 / §9.6",
    cadenceDisplay: "On expiry · SOW §7.5 / §8.5 / §9.6",
    why: "If your day site serves three or fewer people, keep the Office of Licensing Day Support or Community-Based Day Support certification. Same SOW cites as the 4+ Day Treatment license—choose the path that matches the site.",
    links: [EVIDENCE_HELP_LINKS.olApps, EVIDENCE_HELP_LINKS.olRules],
    subject: "company",
    dualLink: null,
  }),
  req({
    key: "company_ol_residential_support_license",
    title: "RHS Residential Support license (4+)",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §21.5(1)",
    cadenceDisplay: "On expiry · SOW §21.5(1)",
    why: "Staffed homes with four or more people need an Office of Licensing Residential Support license. Upload the current license for each qualifying site. Skip if every RHS site is certified under the three-or-fewer path.",
    links: [EVIDENCE_HELP_LINKS.olApps, EVIDENCE_HELP_LINKS.olRules],
    subject: "company",
    dualLink: null,
  }),
  req({
    key: "company_ol_residential_support_cert",
    title: "RHS Residential Support certification (≤3)",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §21.5(2)",
    cadenceDisplay: "On expiry · SOW §21.5(2)",
    why: "RHS sites with three or fewer people use Residential Support certification instead of the 4+ license. Keep the current certificate on the company file.",
    links: [EVIDENCE_HELP_LINKS.olApps, EVIDENCE_HELP_LINKS.olRules],
    subject: "company",
    dualLink: null,
  }),
  req({
    key: "company_ol_child_placing_foster",
    title: "OL Child Placing Foster license",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §20.5",
    cadenceDisplay: "On expiry · SOW §20.5",
    why: "Agencies offering Professional Parent Supports need a current Office of Licensing Child Placing Foster license. This is the agency standing row. A host copy can also live on a professional parent’s staff file if useful.",
    links: [EVIDENCE_HELP_LINKS.olApps, EVIDENCE_HELP_LINKS.olRules],
    subject: "company",
    dualLink: null,
  }),
  req({
    key: "company_designated_acre_holder",
    title: "Designated ACRE-certified staff",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §30.6.b",
    cadenceDisplay: "On expiry · SOW §30.6.b",
    why: "SEI providers must maintain at least one ACRE-certified staff member. Keep a copy of that person’s current certificate on the company file so agency standing is visible even when the staff sei_acre row also exists.",
  ...
  req({
    ...
    cadence: "once",
    sowCite: "SOW §33.5",
    cadenceDisplay: "Before serving · SOW §33.5",
    why: "SJD staff complete USU Customized Employment training before delivering job development. Upload the completion certificate. SEE uses Workplace Supports or Effective Job Coach instead.",
    links: [EVIDENCE_HELP_LINKS.usor, EVIDENCE_HELP_LINKS.forms],
    subject: "staff",
    dualLink: null,
  }),
  req({
    key: "see_workplace_supports_or_job_coach",
    title: "Workplace Supports or Effective Job Coach (USU)",
    evidenceType: "upload",
    attestationText: null,
    cadence: "once",
    sowCite: "SOW §29.4.2",
    cadenceDisplay: "Before serving · SOW §29.4.2",
    why: "SEE staff complete Workplace Supports or Effective Job Coach through USU before delivering Supported Employment Enterprise. Upload the certificate for the path this person completed. Customized Employment stays on the SJD pack.",
    links: [EVIDENCE_HELP_LINKS.usor, EVIDENCE_HELP_LINKS.training],
    subject: "staff",
    dualLink: null,
  }),
  req({
  ...
  req({
    key: "epr_supervisor_acre_or_usu",
    title: "EPR supervisor certification",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §9.5.2",
    cadenceDisplay: "Per program · SOW §9.5.2",
    why: "At least one supervisory staff member per EPR program must hold ACRE, USU Workplace Supports, or Effective Job Coach before that program delivers EPR. Upload the designated supervisor’s certificate here. Other EPR supervisors complete and maintain the same training within 90 days.",
    links: [EVIDENCE_HELP_LINKS.usor, EVIDENCE_HELP_LINKS.training],
    subject: "staff",
    dualLink: null,
  }),
  req({
    ...
    why: "For DSI, DSG, or DSP, keep proof this person was oriented to the day program, ratios, and the people they support. Day-site standing lives on the company file: company_ol_day_treatment_license (4+) or company_ol_day_support_cert (three or fewer). This row is the staff assignment record.",
    subject: "staff",
    dualLink: null,
  }),
  req({
  ...
  req({
    ...
    title: "Child-placing / foster license (host copy)",
    evidenceType: "upload",
    attestationText: null,
    cadence: "keep_current",
    sowCite: "SOW §20.5",
    cadenceDisplay: "On expiry · SOW §20.5",
    why: "Agency standing for PPS is the Office of Licensing Child Placing Foster license on the company file (company_ol_child_placing_foster). Keep a host copy here if this professional parent holds a matching license—do not treat this staff row as the only PPS standing record.",
    links: [EVIDENCE_HELP_LINKS.olApps, EVIDENCE_HELP_LINKS.olRules],
    subject: "staff",
    dualLink: null,
  }),
...
export const EVIDENCE_PACKS: readonly EvidencePackDef[] = [
  ...
  },
  {
    ...
    chip: "SEE",
    subject: "staff",
    description: "Workplace Supports or Effective Job Coach (USU) for enterprise employment.",
    requirementKeys: ["see_workplace_supports_or_job_coach"],
  ...
  },
  {
    ...
    chip: "EPR",
    subject: "staff",
    description: "Employment preparation readiness and supervisor certification.",
    requirementKeys: ["epr_staff_ready", "epr_supervisor_acre_or_usu"],
  ...
  },
  {
    ...
    chip: "PPS",
    subject: "staff",
    description: "Optional host copy of the child-placing license. Agency standing lives on the company file.",
  ...
  {
    key: "company_ol_day",
    title: "OL day site licenses",
    chip: "OL day sites",
    subject: "company",
    description: "Day Treatment license (4+) or Day Support certification (≤3) for DSI/DSG/DSP/EPR sites.",
    requirementKeys: ["company_ol_day_treatment_license", "company_ol_day_support_cert"],
    when: () => true,
  },
  {
    key: "company_ol_residential",
    title: "OL residential licenses",
    chip: "OL residential",
    subject: "company",
    description: "RHS Residential Support license (4+) or certification (≤3).",
    requirementKeys: [
  ...
  {
    key: "company_ol_pps",
    title: "OL Child Placing Foster",
    chip: "OL foster / PPS",
    subject: "company",
    description: "Agency Child Placing Foster license for Professional Parent Supports.",
    requirementKeys: ["company_ol_child_placing_foster"],
    when: () => true,
  },
  {
    key: "company_acre_standing",
    title: "Designated ACRE holder",
    chip: "ACRE standing",
    subject: "company",
    description: "Agency standing that at least one staff member holds ACRE (SEI).",
    requirementKeys: ["company_designated_acre_holder"],
    when: () => true,
  },
  {
