...
describe("catalog live bridge", () => {
  it("maps imported parents onto existing live keys — no second checklist", () => {
    ...
    assert.equal(liveObligationKeyForRequirement("REQ-1.13.4"), "medicaid_provider_training_offered");
    assert.equal(liveObligationKeyForRequirement("REQ-1.28.6"), "rights_restriction_record");
    assert.equal(EXPLICIT_REQ_TO_LIVE_KEY["REQ-1.13.4"], "medicaid_provider_training_offered");
    ...
    assert.equal(liveObligationKeyForRequirement("REQ-16.2.3"), "pm_nursing_file");
    assert.equal(liveObligationKeyForRequirement("REQ-17.4"), "pm_nursing_file");
    assert.equal(liveObligationKeyForRequirement("REQ-18.5"), "pn_medical_care_plan");
    assert.equal(liveObligationKeyForRequirement("REQ-19.2.10"), "pn_medical_care_plan");
    assert.equal(liveObligationKeyForRequirement("REQ-33.2.a"), "sjd_discovery_vocational");
    assert.equal(liveObligationKeyForRequirement("REQ-11.3.1"), "household_12plus_background");
    assert.equal(liveObligationKeyForRequirement("REQ-11.2.7"), "medicaid_eligibility_assist");
    assert.equal(liveObligationKeyForRequirement("REQ-1.19"), "dhhs_quality_remediation");
    assert.equal(liveObligationKeyForRequirement("REQ-7.3.4"), "program_day_to_day_staff");
    assert.equal(liveObligationKeyForRequirement("REQ-28.2.6"), "employment_assessment_fade");
    assert.equal(liveObligationKeyForRequirement("REQ-34.3"), "milestone_rfs");
    assert.equal(liveObligationKeyForRequirement("REQ-9.5.2"), "epr_program_file");
    assert.equal(liveObligationKeyForRequirement("REQ-3.6"), "bc_staff_qualifications");
    assert.equal(liveObligationKeyForRequirement("REQ-21.3.8"), "rhs_housing_voucher");
    assert.equal(liveObligationKeyForRequirement("REQ-21.3.8.A"), "rhs_housing_voucher");
    assert.equal(liveObligationKeyForRequirement("REQ-1.10.14"), "dnr_order_access");
    assert.equal(liveObligationKeyForRequirement("REQ-1.24.7"), "pcsp_person_review");
    assert.equal(liveObligationKeyForRequirement("REQ-1.26"), "fatality_notification");
    assert.equal(liveObligationKeyForRequirement("REQ-1.31.3"), "sc_records_on_request");
    assert.equal(liveObligationKeyForRequirement("REQ-1.32.b"), "residential_group_mix");
    assert.equal(liveObligationKeyForRequirement("REQ-1.36.a"), "usdc_transition");
    assert.equal(liveObligationKeyForRequirement("REQ-10.3.3"), "els_school_age");
    assert.equal(liveObligationKeyForRequirement("REQ-11.3.8"), "host_contractor_change");
    assert.equal(liveObligationKeyForRequirement("REQ-11.6"), "host_staff_qualifications");
    assert.equal(liveObligationKeyForRequirement("REQ-15.2.6"), "pba_monthly_fiduciary");
    assert.equal(liveObligationKeyForRequirement("REQ-21.3.4"), "rhs_form_930");
    assert.equal(liveObligationKeyForRequirement("REQ-23.3.1"), "form_929_exceptional_care");
    assert.equal(liveObligationKeyForRequirement("REQ-27.3"), "sec_pass_documentation");
    assert.equal(liveObligationKeyForRequirement("REQ-29.4.1"), "see_staff_training");
    assert.equal(liveObligationKeyForRequirement("REQ-30.3.3"), "sei_job_termination");
    assert.equal(liveObligationKeyForRequirement("REQ-36.4.1"), "tfb_staff_qualifications");
    assert.equal(liveObligationKeyForRequirement("REQ-1.10"), "person_record_file");
    assert.equal(liveObligationKeyForRequirement("REQ-1.32.a"), "group_service_review_historical");
    assert.equal(liveObligationKeyForRequirement("REQ-11.3.2"), "home_condition_checklist");
    assert.equal(liveObligationKeyForRequirement("REQ-34.5"), "sjp_requires_sjd");
    assert.equal(liveObligationKeyForRequirement("REQ-35.5"), "sjr_requires_see_or_sei");
    assert.equal(liveObligationKeyForRequirement("REQ-7.3.5"), "ol_capacity_comply");
    assert.equal(liveObligationKeyForRequirement("REQ-30.8.1"), "upi_employee_registry");
    ...
    assert.equal(liveObligationKeyForRequirement("REQ-1.4.3"), "agency_license_register");
    assert.equal(liveObligationKeyForRequirement("REQ-1.34"), "agency_license_register");
    assert.equal(liveObligationKeyForRequirement("REQ-1.5"), "staff_minimum_age");
    assert.equal(liveObligationKeyForRequirement("REQ-10.5"), "els_residential_eligibility");
    assert.equal(liveObligationKeyForRequirement("REQ-1.32.c"), "dlbc_group_variance");
    assert.equal(liveObligationKeyForRequirement("REQ-27.5"), "sec_requires_sei");
    assert.equal(liveObligationKeyForRequirement("REQ-33.7.2"), "upi_employee_timesheet");
