...
describe("catalog live bridge", () => {
  it("maps imported parents onto existing live keys — no second checklist", () => {
    ...
    assert.equal(liveObligationKeyForRequirement("REQ-1.10"), null);
    assert.equal(liveObligationKeyForRequirement("REQ-1.32.a"), null);
    assert.equal(liveObligationKeyForRequirement("REQ-11.3.2"), null);
    assert.equal(liveObligationKeyForRequirement("REQ-34.5"), null);
    assert.equal(liveObligationKeyForRequirement("REQ-35.5"), null);
    assert.equal(liveObligationKeyForRequirement("REQ-7.3.5"), null);
    assert.equal(liveObligationKeyForRequirement("REQ-30.8.1"), null);
