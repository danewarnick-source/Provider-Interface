...
export const CATALOG_EXCEPTIONS_BY_KEY: Record<string, CatalogExceptions> = {
  ...
  upi_form_0_9_designee: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_form_0_8_user: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_need_to_know_access: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_1056_decision: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_1056_reject_coordinate: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_1056_utilization: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_provider_organization: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_staff_org_groups: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_staff_notify_prefs: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_person_org_groups: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_remove_terminated_staff: { nonwaivable: true, sei_only: false, assignment_gated: false },
  upi_remove_staff_need_to_know: { nonwaivable: true, sei_only: false, assignment_gated: false },
...
export const CATALOG_IDENTITY_BY_TITLE: Record<string, CatalogIdentity> = {
  ...
  "UPI Form 0-9 — Provider Company Designee Access": {
    key: "upi_form_0_9_designee",
    disposition: "standing",
  },
  "UPI Form 0-8 — Individual User Access": { key: "upi_form_0_8_user", disposition: "standing" },
  "UPI Need-to-Know Access": { key: "upi_need_to_know_access", disposition: "standing" },
  "UPI 1056 Approve or Reject": { key: "upi_1056_decision", disposition: "standing" },
  "UPI 1056 Rejection — Support Coordinator Coordination": {
    key: "upi_1056_reject_coordinate",
    disposition: "standing",
  },
  "UPI 1056 Utilization Monitor": { key: "upi_1056_utilization", disposition: "by_design" },
  "UPI Provider Organization Structure": {
    key: "upi_provider_organization",
    disposition: "standing",
  },
  "UPI Staff Organizational Groups": { key: "upi_staff_org_groups", disposition: "standing" },
  "UPI Staff Email and Notification Preference": {
    key: "upi_staff_notify_prefs",
    disposition: "standing",
  },
  "UPI Person Organizational Groups": { key: "upi_person_org_groups", disposition: "standing" },
  "UPI Remove Terminated Staff — One Calendar Day": {
    key: "upi_remove_terminated_staff",
    disposition: "standing",
  },
  "UPI Remove Staff Need-to-Know — One Calendar Day": {
    key: "upi_remove_staff_need_to_know",
    disposition: "standing",
  },
  "UPI Remove Discharged Person from Provider Organization": {
    key: "upi_remove_discharged_person",
    disposition: "standing",
  },
  "UPI Annual Staff Access Review": { key: "upi_annual_access_review", disposition: "standing" },
  "Notify DSPD USTEPS of UPI Staff Termination — One Calendar Day": {
    key: "upi_notify_usteps_termination",
    disposition: "standing",
  },
