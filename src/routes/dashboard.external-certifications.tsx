      ...
      <div className="rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)] flex flex-wrap items-center justify-between gap-3">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button className="bg-[var(--hive-primary)] text-[var(--hive-primary-fg)]">
  ...
  return (
    <DialogContent>
      ...
      <DialogFooter>
        ...
        <Button disabled={submit.isPending} onClick={() => submit.mutate()} className="bg-[var(--hive-primary)] text-[var(--hive-primary-fg)]">
